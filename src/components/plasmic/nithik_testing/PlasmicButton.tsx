...
import sty from "./PlasmicButton.module.css"; // plasmic-import: l25KR5Jm_il6g/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__y5WgG)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__vp9Xk)}
                role={"img"}
              />
            ),
